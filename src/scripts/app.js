window.onload = () => {
    ...
    function selectFile(buttonElement, text) {
        buttonElement.onclick = () => {
            let sidebarFiles = document.getElementsByClassName("sidebar__file")
            Array.from(sidebarFiles
            ).map((fileElement) => {
    ...
    selectFile(document.getElementsByClassName('file__doing')[0], textHoby)
